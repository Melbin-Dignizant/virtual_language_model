...
def main():
    ...
    parser.add_argument('--model_path', type=str, required=True,
                      help='Path to the local LLaVA model')
    parser.add_argument('--image_path', type=str, required=True,
                      help='Path to the image for analysis')
    parser.add_argument('--prompt', type=str, default=None,
                      help='Initial prompt/question about the image (optional)')
    parser.add_argument('--instruction', type=str, default="You are an expert at analyzing images. Provide detailed, accurate answers about the given image.",
    ...
    # Interactive mode
    print("\n=== LLaVA Image Analysis Interactive Session ===")
